...
<head>
	...
	<script src="js/cui_validation.js"></script>
								...
								<form action="php/register.php" method="post">
									<div class="mdl-grid">
										<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label has-feedback">
												<input class="mdl-textfield__input" type="text" id="cui" name="cui">
												<label class="mdl-textfield__label" for="cui">DPI</label>
												<span class="form-control-feedback glyphicon"></span>
												<span class="mdl-textfield__error">DPI inválido</span>
        ...
        $(document).ready(function() {
            $('#cui').on('input', function() {
                ...
                if (cuiIsValid(cui)) {
                    ...
                    $parent.find('.form-control-feedback').addClass('glyphicon-ok');
                    $parent.find('.form-control-feedback').removeClass('glyphicon-remove');
                } else {
                    $parent.addClass('has-error');
                    $parent.removeClass('has-success');
                    $parent.find('.form-control-feedback').addClass('glyphicon-remove');
                    $parent.find('.form-control-feedback').removeClass('glyphicon-ok');
                }
            });
            ...
            function cuiIsValid(cui) {
                ...
                // Verificación del correlativo con el algoritmo del complemento 11
                var total = 0;
                ...
                return modulo === verificador;
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="text" pattern="-?[A-Za-záéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="NameAdmin" name="name" required>
												<label class="mdl-textfield__label" for="NameAdmin">Nombres</label>
												<span class="mdl-textfield__error">Invalid name</span>
											</div>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="text" pattern="-?[A-Za-záéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="LastNameAdmin" name="lastName" required>
												<label class="mdl-textfield__label" for="LastNameAdmin">Apellidos</label>
												<span class="mdl-textfield__error">Invalid last name</span>
											</div>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="tel" pattern="-?[0-9+()- ]*(\.[0-9]+)?" id="phoneAdmin" name="phone" required>
												<label class="mdl-textfield__label" for="phoneAdmin">Teléfono</label>
												<span class="mdl-textfield__error">Invalid phone number</span>
											</div>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="email" id="emailAdmin" name="email" required>
												<label class="mdl-textfield__label" for="emailAdmin">E-mail</label>
												<span class="mdl-textfield__error">Invalid E-mail</span>
											</div>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="text" id="addressAdmin" name="address" required>
										...
										<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="text" pattern="-?[A-Za-z0-9áéíóúÁÉÍÓÚ]*(\.[0-9]+)?" id="UserNameAdmin" name="username" required>
												<label class="mdl-textfield__label" for="UserNameAdmin">Usuario</label>
												<span class="mdl-textfield__error">Invalid user name</span>
											</div>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input class="mdl-textfield__input" type="password" id="passwordAdmin" name="password" required>
											...
											<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-1">
												<input type="radio" id="option-1" class="mdl-radio__button" name="avatar" value="avatar-male.png">
												<img src="assets/img/avatar-male.png" alt="avatar" height="45px" width="45px">
											...
											<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-2">
												...
												<img src="assets/img/avatar-female.png" alt="avatar" height="45px" width="45px">
											...
											<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-3">
												...
												<img src="assets/img/avatar-male2.png" alt="avatar" height="45px" width="45px">
											...
											<label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-4">
												...
												<img src="assets/img/avatar-female2.png" alt="avatar" height="45px" width="45px">
												<span class="mdl-radio__label">Avatar 4</span>
											</label>
										</div>
									</div>
									<p class="text-center">
										<button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored bg-primary" id="btn-addAdmin" type="submit">
